<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
    ...
    {{-- @if (auth()->user()->id == 1)
        <div class="menu-item">
            <div class="menu-content pt-8 pb-2">
                <span
                    class="menu-section text-muted text-uppercase fs-8 ls-1">{{ __('navbar.admin_management') }}</span>
            </div>
        </div>
        <div class="menu-item">
    ...
    @if (auth()->user()->type == 'system-manager' ||
            auth()->user()->type == 'hospital-manager' ||
            auth()->user()->type == 'doctor-manager')

        <div class="menu-item">
            <div class="menu-content pt-8 pb-2">
                <span class="menu-section text-muted text-uppercase fs-8 ls-1">HR Managment</span>
            </div>
        </div>
        ...
        @if (auth()->user()->type == 'system-manager' ||
                ...
                auth()->user()->type == 'doctor-manager')
            <div class="menu-item">
                <a class="menu-link {{ in_array(Route::currentRouteName(), ['managers.index']) ? 'active' : '' }}"
                    ...
                    <span class="menu-title">Doctors Managers</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ in_array(Route::currentRouteName(), ['doctors.index']) ? 'active' : '' }}"
    ...
    @if (auth()->user()->type != 'Doctor')
        ...
        <div class="menu-item">
            <a class="menu-link {{ in_array(Route::currentRouteName(), ['files.index', 'files.show']) ? 'active' : '' }}"
                ...
                <span class="menu-title">Patients File</span>
            </a>
        </div>

        <div class="menu-item">
            <a class="menu-link {{ in_array(Route::currentRouteName(), ['files.create']) ? 'active' : '' }}"
    ...
    @if (auth()->user()->type == 'system-manager' ||
        ...
        <div class="menu-item">
            <a class="menu-link {{ in_array(Route::currentRouteName(), ['appoinments.index', 'appoinments.show']) ? 'active' : '' }}"
    ...
    {{--
        ...
        <div class="menu-item">
            <div class="menu-content pt-8 pb-2">
                <span
                    class="menu-section text-muted text-uppercase fs-8 ls-1">{{ __('navbar.website_settings') }}</span>
            </div>
        </div>
        <div class="menu-item">
