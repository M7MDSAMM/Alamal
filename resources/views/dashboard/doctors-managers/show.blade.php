            ...
            <div id="kt_content_container" class="container-xxl" style="max-width: 1800px">
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::currentRouteName() == 'managers.show' || Route::currentRouteName() == 'account.profile' ? 'active' : '' }}"
                                    href="{{ Route::currentRouteName() == 'managers.edit' || Route::currentRouteName() == 'managers.show' ? route('managers.show',$doctor) : route('account.profile') }}">{{__('admins.overview')}}</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::currentRouteName() == 'managers.edit' || Route::currentRouteName() == 'account.settings' ? 'active' : '' }}"
                                    href="{{ Route::currentRouteName() == 'managers.edit' || Route::currentRouteName() == 'managers.show' ? route('managers.edit',$doctor) : route('account.settings') }}">{{__('admins.settings')}}</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header cursor-pointer">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="{{ route('admins.edit',$doctor) }}"
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{$doctor->email }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{$doctor->created_at->format('Y-m-d h:i a') }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
