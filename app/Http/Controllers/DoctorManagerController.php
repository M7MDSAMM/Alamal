...
use App\Http\Requests\StoreDoctorManagerRequest;
use App\Http\Requests\UpdateDoctorManagerRequest;
...
class DoctorManagerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('dashboard.doctors-managers.index',compact('doctors'));
    }
     ...
     */
    public function store(StoreDoctorManagerRequest $request)
    {
        //
    ...
    public function show(string $id)
    {
        ...
        return response()->view('dashboard.doctors-managers.show',compact('doctor'));
    }
    ...
    public function edit(string $id)
    {
        //
        $doctor = Admin::findOrFail($id);
        return response()->view('dashboard.doctors-managers.edit',compact('doctor'));
     ...
     */
    public function update(UpdateDoctorManagerRequest $request, string $id)
    {
